...
class Settings(BaseSettings):
    ...
    competitor_price_max_evidence_items: int = Field(default=60, ge=1, le=200)
    competitor_price_max_excerpt_chars: int = Field(default=3_000, ge=200, le=10_000)
    competitor_price_max_total_evidence_chars: int = Field(default=80_000, ge=1_000, le=500_000)
    competitor_price_model_timeout_seconds: float = Field(default=180, ge=1, le=600)
    competitor_review_max_evidence_items: int = Field(default=80, ge=1, le=200)
    ...
    technical_feasibility_max_evidence_items: int = Field(default=160, ge=1, le=300)
    technical_feasibility_max_excerpt_chars: int = Field(default=3_000, ge=200, le=10_000)
    technical_feasibility_max_total_evidence_chars: int = Field(
        default=200_000, ge=1_000, le=1_000_000
    )
    technical_feasibility_model_timeout_seconds: float = Field(default=180, ge=1, le=600)
    security_policy_max_evidence_items: int = Field(default=160, ge=1, le=300)
    security_policy_max_excerpt_chars: int = Field(default=3_000, ge=200, le=10_000)
    security_policy_max_total_evidence_chars: int = Field(
        default=200_000, ge=1_000, le=500_000
    )
    security_policy_model_timeout_seconds: float = Field(default=180, ge=1, le=600)
    commercial_evaluation_max_evidence_items: int = Field(default=200, ge=1, le=300)
    commercial_evaluation_max_excerpt_chars: int = Field(default=3_000, ge=200, le=10_000)
    commercial_evaluation_max_total_evidence_chars: int = Field(
    ...
    competitor_discovery_max_snippet_chars: int = Field(default=1_000, ge=100, le=2_000)
